...
```scala
addSbtPlugin("dev.zio" % "zio-sbt-ecosystem" % "0.4.0-alpha.15")
addSbtPlugin("dev.zio" % "zio-sbt-ci"        % "0.4.0-alpha.15")
addSbtPlugin("dev.zio" % "zio-sbt-website"   % "0.4.0-alpha.15")
```
